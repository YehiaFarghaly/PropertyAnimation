...
class MainActivity : AppCompatActivity() {
    ...
    private fun shower() {
        ...
        newStar.translationX = Math.random().toFloat() *
                containerW - starW / 2
        val animator1:ObjectAnimator = ObjectAnimator.ofFloat(newStar,View.ROTATION, (Math.random() * 1080).toFloat())
        animator1.interpolator=LinearInterpolator()
 val animator2:ObjectAnimator = ObjectAnimator.ofFloat(newStar,View.TRANSLATION_Y,-starH,containerH+starH)
    animator2.interpolator = AccelerateInterpolator(1f)
        val set = AnimatorSet()
